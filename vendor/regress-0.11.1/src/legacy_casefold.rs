...
//!
//! Generated with the project's reference runtime (Node.js 24) by applying
//! the non-Unicode Canonicalize algorithm to every UTF-16 code unit. Keeping
//! this table local makes legacy /i behavior deterministic across platforms
//! and independent of the Unicode version used by Rust's standard library.
